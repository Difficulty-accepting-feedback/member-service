...
public class PointCommandServiceImpl implements PointCommandService {
	 ...
	 * @param event 이벤트 객체
	 */
	private void sendIfDedupeOkAndPublish(String dedupKey, Long historyId, Long memberId, PointNotificationEvent event) {
		...
		String payload = JsonUtils.toJsonString(event); // 멤버처럼 record 그대로 직렬화
